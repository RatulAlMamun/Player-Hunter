                     ...
                     <table class="table table-bordered">
                       <thead>
                         <tr>
                           ...
                           <th>Runs <br> {{ $runs }}</th>
                           <th>Wickets <br> {{ $wickets }}</th>
                           <th>Catch Misses <br> {{ $catch_misses }}</th>
                         </tr>
                       </thead>
                     </table>
                  </div>
                     ...
                     <table class="table">
                       <thead class="thead-dark">
                         <tr>
                           ...
                           <th scope="col">Play OF</th>
                           <th scope="col">Appearances</th>
                           <th scope="col">Runs</th>
                           <th scope="col">Wikets</th>
                           <th scope="col">Cautch Missing</th>
                        ...
                        @if(!empty($careers))
                          @foreach($careers as $career)
                             <tr>
                               ...
                               <td>{{ $career->club }}</td>
                               <td>{{ $career->play_off }}</td>
                               <td>{{ $career->appearances }}</td>
                               <td>{{ $career->runs }}</td>
                               <td>{{ $career->wickets }}</td>
                               <td>{{ $career->catch_misses }}</td>
                               <td>{{ $career->rating }}%</td>
                             </tr>
                          @endforeach
                        @endif

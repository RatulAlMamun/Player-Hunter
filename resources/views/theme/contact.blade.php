...
@section('content')
         ...
         <div class="row bg-success">
            <div class="col-12">
               <h1 class="display-2">{{ session('contact') }}</h1>
            </div>
         </div>
         @endif
               ...
               <div class="contact">
                  ...
                  <div class="col-md-6">
                     <div class="contact-us">
                        <form method="POST" action="{{ route('contact.submit') }}" class="comments-form">
                           @csrf
                           <ul>
                              <li><input type="text" id="name" name="name" class="required" placeholder="Name *" required></li>
                              <li><input type="email" id="email" name="email" class="required email" placeholder="Email *" required></li>
                              <li><input type="text" name="address" id="address" placeholder="Address:" required></li>
                              <li><textarea name="message" id="message" placeholder="Add your message" required></textarea></li>
                              <li><input class="thbg-color" type="submit" value="Send" style="background: #aa0000;color:#fff;"></li>
                           </ul>
                        </form>
                     </div>
                  </div>

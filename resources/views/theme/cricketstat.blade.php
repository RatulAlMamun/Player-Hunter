    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row row-offcanvas row-offcanvas-right">
        ...
        <div class="content-wrapper">
          <h1 class="page-title">Cricket Stats Centre</h1>
          <div class="card">
            <div class="card-body">
              <h2 class="card-title">Premier League Cricket Player Stats</h2>
              <div class="row">
                <div class="col-12">
                      ...
                      @if(!empty($players))
                        @foreach($players as $player)
                          <tr>
                            ...
                            <td>
                              <a href="{{route('cricketplayer.profile', ['id'=> $player->id])}}" class="btn btn-outline-primary">View</a>
                            </td>
                        </tr>
                        @endforeach
                      @endif
